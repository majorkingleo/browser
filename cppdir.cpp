...
CppDir::File::Type CppDir::File::get_type( const std::string& name )
{
...
std::ostream& CppDir::operator << ( std::ostream& out , File::Type type )
{
  switch( type )
    {
    case File::UNKNOWN: out << "UNKNOWN"; break;
    case File::FIFO   : out << "FIFO"   ; break;
    case File::CHAR   : out << "CHAR"   ; break;
    case File::DIR    : out << "DIR"    ; break;
    case File::BLOCK  : out << "BLOCK"  ; break;
    case File::REGULAR: out << "REGULAR"; break;
    case File::LINK   : out << "LINK"   ; break;
    }
  return out;
}
